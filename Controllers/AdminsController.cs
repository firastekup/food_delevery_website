...
namespace food_delevery_google_auth_Final_V.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAdmin,NomUtilisateur,MotDePasse,Email,DateCreation")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAdmin,NomUtilisateur,MotDePasse,Email,DateCreation")] Admin admin)
        {
            if (id != admin.IdAdmin)
            {
                return NotFound();
